...
class SprintHandler(WebSocketHandler):
    ...
    def open(self):
        """Subscrible to sprint updates on a new connection."""
        self.sprint = None
...
class UpdateHandler(RequestHandler):
    """Handle udpates from the Django application."""
...
if __name__ == "__main__": # 运行： python watercooler.py --debug
    # Application通过指向websocket处理器的单一路由来构建，监听8080端口
    parse_command_line()
