(function ($, Backbone, _, app) {
    ...
    var SprintView = TemplateView.extend({
        ...
        initialize: function (options) {
            ...
            _.each(this.status, function (view, name) {
                view.on('drop', function (model) { // 监听每一个StatusView实例的drop事件
                    this.socket.send({
                        model: 'task',
                        id: model.get('id'),
                        action: 'drop'
